...
@interface MYMainViewController ()<UIAlertViewDelegate, IChatManagerDelegate, EMCallManagerDelegate>
{
    ConversationListController *_chatListVC;
    ContactListViewController *_contactsVC;
    XWPageViewController *_fileVC;
...
- (void)viewDidLoad {
    ...
    [self addChildVc:_chatListVC title:@"消息" image:@"home2_tab_1@3x" selectedImage:@"home2_tab_12@3x"];
    MYTaskViewController *taskVc = [[MYTaskViewController alloc]init];
    [self addChildVc:taskVc title:@"签到" image:@"home2_tab_2@3x" selectedImage:@"home2_tab_22@3x"];
    _contactsVC = [[ContactListViewController alloc]init];
    [self addChildVc:_contactsVC title:@"通讯录" image:@"home2_tab_3@3x" selectedImage:@"home2_tab_32@3x"];
    MYNewsViewController *annoVc = [[MYNewsViewController alloc]init];
    [self addChildVc:annoVc title:@"公告" image:@"home2_tab_4@3x" selectedImage:@"home2_tab_42@3x"];
    LocalFileViewController *localVC = [[LocalFileViewController alloc]init];
    DownloadFileViewController *downVC = [[DownloadFileViewController alloc]init];
    NSArray *viewControllers = [NSArray arrayWithObjects:localVC,downVC, nil];
    NSArray *titles = @[@"本地文件",@"网络文件"];
    _fileVC = nil;
    _fileVC = [[XWPageViewController alloc] initWithViewControllers:viewControllers titles:titles isShowPageIndicator:NO segmentShowType:XWPageVCSegmentShowTypeTitleView toIndex:0];
    _fileVC.segmentTintColor = [UIColor whiteColor];
    [self addChildVc:_fileVC title:@"文件" image:@"home2_tab_5@3x" selectedImage:@"home2_tab_52@3x"];
...
-(void)addChildVc:(UIViewController *)childVc title:(NSString *)title image:(NSString *)image selectedImage:(NSString *)selectedImage{
    ...
    textAttrs[NSForegroundColorAttributeName] = YKTabBarItemTitileColor(102, 102, 102);
    NSMutableDictionary *selectedAttrs = [NSMutableDictionary dictionary];
    selectedAttrs[NSForegroundColorAttributeName] =  YKTabBarItemTitileColor(76, 162, 247);
    [childVc.tabBarItem setTitleTextAttributes:textAttrs forState:UIControlStateNormal];
    [childVc.tabBarItem setTitleTextAttributes:selectedAttrs forState:UIControlStateSelected];
    //设置子控制器的背景颜色
    childVc.view.backgroundColor = [UIColor whiteColor];
    //包装导航控制器
    MYButtonNavigationController *nvc = [[MYButtonNavigationController alloc] initWithRootViewController:childVc];
    //选择自己喜欢的颜色
...
- (void)showNotificationWithMessage:(EMMessage *)message
{
    ...
    if (options.displayStyle == ePushNotificationDisplayStyle_messageSummary) {
        ...
        NSString *title = [ERPCache getContact:message.from].nickname;
...
- (void)_removeBuddies:(NSArray *)userNames
{
    ...
    [self showHint:[NSString stringWithFormat:@"%@被删除了",[ERPCache getContact:userNames[0]].nickname]];
}
