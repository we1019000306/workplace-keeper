...
- (void)setMenuArray {
    ...
    menuImgArray = [NSMutableArray arrayWithObjects:png_Icon_Menu_PersonalCenter, png_Icon_Menu_FiveStar, png_Icon_Menu_Feedback, png_Icon_Menu_Messages, png_Icon_Menu_About, nil];
    menuArray = [NSMutableArray arrayWithObjects:str_ViewTitle_4, str_ViewTitle_7, str_ViewTitle_8, str_ViewTitle_12, str_ViewTitle_9, nil];
}
...
- (void)pushLoginPage {
    UINavigationController *navController = (UINavigationController *)((UITabBarController *)self.sideMenuViewController.contentViewController).selectedViewController;
    MYPersonUniversalViewController *controller = [[MYPersonUniversalViewController alloc] init];
